...
export const VideoCarousel = () => {
  ...
  const sliderLength = hightlightsSlides.length;
  ...
  useGSAP(() => {
    ...
    // video animation to play video when it is in the view
    gsap.to("#video", {
      scrollTrigger: {
        trigger: "#video",
  ...
  useEffect(() => {
    ...
    if (span[videoId]) {
      ...
      if (isPlaying) {
        ...
        // remove the ticker when the video is pause (progress bar is stoped)
  ...
  useEffect(() => {
    if (loadedData.length === sliderLength) {
      if (!isPlaying) {
